...
begin
    ...
    then 
        raise_application_error(-20001, 'Tiene que haber un minimo de 12 equipos
...
COMPOUND TRIGGER
  ...
  BEGIN
    ...
    v_dinero_total := v_dinero_total + v_salario + v_clausula;
...
COMPOUND TRIGGER
  ...
  BEGIN
    ...
    then
        raise_application_error(-20001, 'No puede haber mas de un miembro con la
        misma función');
    end if;
