...
AS
    ...
    CURSOR cursor_lista_cod_equipo IS 
        SELECT cod_equipo FROM equipos_participantes 
                ...
                loop
                    ...
                    then
                        ...
                        then
                            ...
                            insert into partidos values(codJornada, default, array_partidos(index_min).cod_equipo1, array_partidos(index_min).cod_equipo2, v_hora, null, default);
